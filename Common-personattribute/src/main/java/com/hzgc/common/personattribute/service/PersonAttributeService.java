...
public class PersonAttributeService {
    public List<PersonAttribute> getPersonAttribute(){
        ...
        //行人年龄
        Map<Integer ,String> ageMap = personMap.get("age");
        ...
        //小孩类型
        Map<Integer ,String> babyMap = personMap.get("baby");
        ...
        //拎东西
        Map<Integer ,String> bagMap = personMap.get("bag");
        ...
        //下衣颜色
        Map<Integer ,String> bottomColorMap = personMap.get("bottomColor");
        ...
        //下衣类型
        Map<Integer ,String> bottomTypeMap = personMap.get("bottomType");
        ...
        //帽子类型
        Map<Integer ,String> hatMap = personMap.get("hat");
        ...
        //头发类型
        Map<Integer ,String> hairMap = personMap.get("hair");
        ...
        //背包类型
        Map<Integer ,String> knapsackMap = personMap.get("knapsack");
        ...
        //背包方式
        Map<Integer ,String> messengerBag = personMap.get("messengerBag");
        ...
        //行人方向
        Map<Integer ,String> orientation = personMap.get("orientation");
        ...
        //性别
        Map<Integer ,String> sex = personMap.get("sex");
        ...
        //肩上的包
        Map<Integer ,String> shoudlerBag = personMap.get("shoudlerBag");
        ...
        //雨伞
        Map<Integer ,String> umbrella = personMap.get("umbrella");
        ...
        //上衣颜色
        Map<Integer ,String> upperColor = personMap.get("upperColor");
        ...
        //上衣类型
        Map<Integer ,String> upperType = personMap.get("upperType");
        ...
        //车辆类型
        Map<Integer ,String> type = personMap.get("type");
